    ...
    public partial class initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MovieActorLinks", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MovieActorLinks_Actors_Actorid",
                        column: x => x.Actorid,
                        principalTable: "Actors",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_MovieActorLinks_Movies_Movieid",
                        column: x => x.Movieid,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MovieActorLinks_Actorid",
                table: "MovieActorLinks",
                column: "Actorid");

            migrationBuilder.CreateIndex(
                name: "IX_MovieActorLinks_Movieid",
                table: "MovieActorLinks",
                column: "Movieid");
        }
